...
\begin{figure}[htp]
	\centering
	\includegraphics[scale=0.4]{Get_Model_Scheme_high_reso}
...
\begin{figure}
	\centering
	\includegraphics[scale=0.5]{Training_lstm_high_reso}
...
\begin{figure}[t]
	\centering
	\includegraphics[scale=0.5]{Testing_lstm_high_reso}
...
\begin{figure}[htp]
	\centering
	\includegraphics[scale=0.5]{Sistem_all_high_reso}
